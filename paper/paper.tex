...
retains \emph{that} it moves, not \emph{the} cycle. Stronger coupling
mechanisms (explicit neighbor phase terms, reduced firing noise, longer
curricula) are the obvious next experiments. MSE training softens precise
